...
public class Username_Dislikes_Activity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerAdapter<DislikeUsernamPhoto, DislikeViewHolder> populateRecView = new FirebaseRecyclerAdapter<DislikeUsernamPhoto, DislikeViewHolder>(
                DislikeUsernamPhoto.class,
                R.layout.username_dislike_row,
                DislikeViewHolder.class,
                dislikesReferences
        ) {


            @Override
            protected void populateViewHolder(DislikeViewHolder viewHolder, DislikeUsernamPhoto model, int position) {
