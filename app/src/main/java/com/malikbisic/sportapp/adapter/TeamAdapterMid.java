...
public class TeamAdapterMid extends RecyclerView.Adapter<TeamSquadViewHolder> {
    Context context;
    Activity activity;
    ArrayList<TeamModel> teamList;

    public TeamAdapterMid() {
    }

    public TeamAdapterMid(Context context, Activity activity, ArrayList<TeamModel> teamList) {
