...
public class ResultsLeagueModel {
    ...
    public ResultsLeagueModel() {
    }

    public ResultsLeagueModel(String localTeamName, String localTeamLogo, String visitorTeamName, String visitorTeamLogo, String timeStart, String leagueName, Date date, String status, String score, String idFixtures, int localTeamId, int visitorTeamId) {
