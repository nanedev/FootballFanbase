...
public class NotificationFragment extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       setContentView(R.layout.fragment_notification);
        ...
        notificationRecView = (RecyclerView) findViewById(R.id.notification_recView);
    ...
    public void onStart() {
        ...
        FirestoreRecyclerAdapter<Notification, NotificationViewHolder> populateAdapter = new FirestoreRecyclerAdapter<Notification, NotificationViewHolder>(options) {
            ...
            protected void onBindViewHolder(final NotificationViewHolder viewHolder, int position, Notification model) {
                ...
                viewHolder.setUid(NotificationFragment.this, model.getUid());
                viewHolder.setAction(model.getAction(), model.getWhatIS());
                viewHolder.setTimeAgo(model.getTimestamp(), NotificationFragment.this);
                viewHolder.isSeen(model.isSeen(), NotificationFragment.this);
                        ...
                        getKey.addSnapshotListener(new EventListener<DocumentSnapshot>() {
                            ...
                            public void onEvent(DocumentSnapshot dataSnapshot, FirebaseFirestoreException e) {
                                ...
                                if (whatIS.equals("post")) {
                                    Intent openSinglePost = new Intent(NotificationFragment.this, SinglePostViewNotificationActivity.class);
                                    ...
                                    Intent openCom = new Intent(NotificationFragment.this, CommentsActivity.class);
                                    ...
                                    Intent intent = new Intent(NotificationFragment.this, CommentsInComments.class);
                                                ...
                                                if (items[which].equals("Delete notification")) {
                                                    notificationRef.collection("Notification").document(auth.getCurrentUser().getUid()).collection("notif-id").document(post_key_notification).delete().addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            Toast.makeText(NotificationFragment.this, "Deleted", Toast.LENGTH_LONG).show();
                                                        }
                                                    }).addOnFailureListener(new OnFailureListener() {
                                                        @Override
                                                        public void onFailure(@NonNull Exception e) {
